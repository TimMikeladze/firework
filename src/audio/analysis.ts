/**
 * Client-side music analysis, shared by the builder's synced show and the
 * rhythm game's beatmap generator.
 *
 * Pipeline: downmix → STFT magnitude frames → spectral flux → adaptive-threshold
 * peak picking → tempo estimate by inter-onset histogram → section segmentation
 * by windowed energy.
 *
...
/** The section covering `time`, or a neutral stand-in for an empty list. */
